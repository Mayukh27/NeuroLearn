...
"[project]/lib/dummyDb.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// ============================================================
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/dummyDb.ts [app-ssr] (ecmascript)");
;
// ── Config ──
...
async function fetchStudentProfile() {
    return apiFetch("/student/profile?student_id=student_001", {
        ...
        await delay(200);
        return JSON.parse(JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DUMMY_STUDENT"]));
    });
}
async function awardXP(amount, studentId = "student_001") {
    return apiFetch("/student/xp", {
        ...
        await delay(100);
        const s = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DUMMY_STUDENT"];
        s.xp += amount;
...
async function sendAttentionFrame(frameBase64, videoId, studentId = "student_001") {
    ...
    }, async ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateAttentionSnapshot"])());
}
...
async function fetchTranscription(videoId) {
    return apiFetch(`/transcription/${videoId}`, {
        ...
        await delay(200);
        return JSON.parse(JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DUMMY_TRANSCRIPT_SEGMENTS"]));
    });
}
async function fetchLiveTranscriptSegment(videoId, currentTime) {
    return apiFetch(`/transcription/${videoId}/live?current_time=${currentTime}`, {
        ...
        const seg = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DUMMY_TRANSCRIPT_SEGMENTS"].find((t)=>currentTime >= t.startTime && currentTime < t.endTime);
...
async function transcribeAudioChunk(videoId, audioBase64) {
    return apiFetch("/transcription/chunk", {
        ...
        body: JSON.stringify({
            ...
            segments: JSON.parse(JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DUMMY_TRANSCRIPT_SEGMENTS"]))
        }));
}
async function generateAssessment(courseId, videoId, attentionScore, previousScore, transcriptText = "") {
    return apiFetch("/assessment/generate", {
        ...
        const questions = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["QUESTION_BANK"][difficulty].slice(0, 5);
        const timeLimits = {
            easy: 600,
            medium: 420,
            hard: 300
...
async function submitAssessment(sessionId, answers, questions, timeSpent) {
    return apiFetch("/assessment/submit", {
        ...
        const csrScore = 0.2 * csrComponents.performance + 0.2 * csrComponents.attention + 0.2 * csrComponents.integrity + 0.2 * csrComponents.trend + 0.2 * csrComponents.complexity;
        return {
            sessionId,
            score: pct,
            totalPoints: total,
...
// ============================================================
function dummyCsrHistory(studentId) {
...
async function fetchCurrentCsr(studentId = "student_001") {
    return apiFetch(`/csr/${studentId}`, {
        method: "GET"
    }, async ()=>{
        await delay(150);
...
async function fetchCsrHistory(studentId = "student_001", limit) {
    const query = limit ? `?limit=${limit}` : "";
    return apiFetch(`/csr/${studentId}/history${query}`, {
        method: "GET"
    }, async ()=>{
        await delay(200);
        return {
            history: dummyCsrHistory(studentId)
        };
    }).then((res)=>res.history ?? res);
}
async function fetchLeaderboard() {
    return apiFetch("/leaderboard", {
        ...
        await delay(250);
        return JSON.parse(JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DUMMY_LEADERBOARD"]));
    });
}
async function fetchDailyChallenges() {
    return apiFetch("/challenges/daily", {
        ...
        await delay(150);
        return JSON.parse(JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DUMMY_DAILY_CHALLENGES"]));
    });
}
async function fetchNotifications() {
    return apiFetch("/notifications?student_id=student_001", {
        ...
        await delay(100);
        return JSON.parse(JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dummyDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DUMMY_NOTIFICATIONS"]));
    });
}
...
function Navbar({ studentName, level, xp, xpToNextLevel, streak }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchNotifications"])().then(setNotifications);
    }, []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].nav, {
        initial: {
            opacity: 0,
...
function DashboardLayout({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchStudentProfile"])().then(setStudent);
    }, []);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__843fcddc._.js.map